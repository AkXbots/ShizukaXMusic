    ...
    if GITHUB_REPO and OWNER:
        buttons.append(
            [
                ...
                InlineKeyboardButton(text=_["S_B_6"], url=f"https://youtube.com/@Its_Star_Boihttps://t.me/ll_Her_Boy_ll"),
            ]
        )
    else:
        if GITHUB_REPO:
            buttons.append(
                [
                    InlineKeyboardButton(text=_["S_B_6"], url=f"https://t.me/Night_club_chatting"),
                ]
            )
        if OWNER:
            buttons.append(
